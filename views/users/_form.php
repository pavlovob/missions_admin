...
<div class="w3-row">
  ...
  <!-- <div class="w3-third w3-container w3-small"> -->
    ...
    <?php  $form = ActiveForm::begin(['layout' => 'horizontal']);?>
      ...
      <?= ($pwd == 0) ? $form->field($model, 'username')->textInput(['autofocus' => true]):null ?>
      ...
      <?= ($pwd == 0) ? $form->field($model, 'username')->textInput(['autofocus' => true]):null ?>
      <?= ($pwd == 0) ? $form->field($model, 'assignerid')->dropdownList($assigners,['id'=>'uid','prompt'=>'Куратор от...']):null ?>
      <?= ($pwd == 0) ? $form->field($model, 'executerid')->dropdownList($executers,['id'=>'uid','prompt'=>'Исполнитель от...']):null ?> 
